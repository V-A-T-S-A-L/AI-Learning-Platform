...
import { BookOpen, MessageSquare, FileText, ListChecks, CloudDownload } from "lucide-react"
	...
	return (
		<div className="h-full flex flex-col bg-black">
			...
			<Tabs defaultValue="flashcards" className="flex-1 flex flex-col min-h-0">
				...
				<TabsList className="flex-shrink-0 grid w-full grid-cols-5 bg-black border-zinc-800 rounded-none h-14">
					<TabsTrigger
						value="flashcards"
