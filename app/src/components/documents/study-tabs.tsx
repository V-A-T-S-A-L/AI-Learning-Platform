    ...
    <div className="h-full flex flex-col bg-black">
      ...
      <Tabs defaultValue="summary" className="flex-1 flex flex-col min-h-0">
        ...
        <TabsList className="flex-shrink-0 grid w-full grid-cols-4 bg-zinc-950 border-b border-zinc-800 rounded-none h-14">
          <TabsTrigger
            value="flashcards"
            className="text-zinc-400 hover:text-zinc-200 hover:bg-zinc-800/50 rounded-xl mx-1 my-2 transition-all duration-200 data-[state=active]:bg-zinc-900 data-[state=active]:text-purple-400 data-[state=active]:shadow-lg"
          >
